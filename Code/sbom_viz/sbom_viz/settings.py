"""
Django settings for sbom_viz project.
...
SECRET_KEY = "django-insecure-3@$m!wq^lkmku7rcg14yl)r-r^s445*$-dm=elxgz8f!&s+)&!"
...
WSGI_APPLICATION = "sbom_viz.wsgi.application"
